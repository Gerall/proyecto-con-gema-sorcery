...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { apellidos: @buyer.apellidos, direccion: @buyer.direccion, fch_ncto: @buyer.fch_ncto, nombres: @buyer.nombres }
    end
  ...
  test "should update buyer" do
    put :update, id: @buyer, buyer: { apellidos: @buyer.apellidos, direccion: @buyer.direccion, fch_ncto: @buyer.fch_ncto, nombres: @buyer.nombres }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
